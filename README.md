...
- We spent a lot of time experimenting with ways to increase data quality (our main road block) by creating more robust triplets. [More information can be found about some of these efforts here.](Triplet_Loss_Triplet_Generation_Examined)
## Stakeholders
